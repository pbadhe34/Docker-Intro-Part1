...
Assign Volume to Redis container
  ...
  docker run -d --name redis-container -h redis-host -v /data/redis:/data redis:latest

Assign the app container link to redis container

  docker run -d -p 4000:8090 -it --link redis-cpontainer:redis --name app  -h app-host test-app:v1
